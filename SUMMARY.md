...
* [4. java虚拟机](jvm/jvm.md)
    ...
    * [4.2：工具](jvm/tools.md)
        * [4.2.1：jps](jvm/tools_jps.md)
        * [4.2.2：jstat](jvm/tools_jstat.md)
        * [4.2.3：jinfo](jvm/tools_jinfo.md)
        * [4.2.4：jmap](jvm/tools_jmap.md)
        * [4.2.5：jhat](jvm/tools_jhat.md)
        * [4.2.6：jstack](jvm/jstack.md)
        * [4.2.7：jconsole](jvm/tools_jsonsole.md)
        * [4.2.8：visualvm](jvm/tools_visualvm.md)
    ...
    * [4.5：内存分配](jvm/memory_distribution.md)
        * [4.5.1：内存分配策略](jvm/memory_strategy.md)
        * [4.5.2：对象优先在Eden分配](jvm/memory_eden.md)
        * [4.5.3：大对象直接分配到老年代](jvm/memory_old.md)
        * [4.5.4：空间分配担保](jvm/memory_promotion.md)
